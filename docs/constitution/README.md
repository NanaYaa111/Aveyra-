...
| [volume-1-user-research-findings.md](volume-1-user-research-findings.md) | **User Research Findings & Product Validation (n=26)** — second-wave survey synthesised into decision-linked themes; validates communication-first, privacy-first, and the no-gamification stance; honest limitations + flagged conflicts (games/AI-emotion-analysis out by principle) |
| [volume-3-part-1-design-system.md](volume-3-part-1-design-system.md) | **Volume 3 — Design System & UX** (Part 1 A–E: Philosophy, Brand, Colour, Typography, Spacing + Accessibility Contrast Standard; Part 2 F: Buttons). Affirms the built calm/content-first system; **Q27 flags the one material conflict** — Volume 3's Blue+Coral palette vs the built Evergreen+Gold "First Light" |
...
| [volume-2-part-3-sections-j-to-n.md](volume-2-part-3-sections-j-to-n.md) | **Part 3 feature specs J–N** — Notifications, Relationship Settings, Media Storage, Account/Identity/Auth, Offline-First Architecture *(conflicts resolved: Q15 → passwordless OTP, Section M password language superseded; Q16 → web-first, Section N reframed as graceful disconnection)* |
